...
-- --------------------------------------------------
-- Date Created: 09/12/2015 09:35:40
-- Generated from EDMX file: C:\Users\Ljubisha\Documents\Visual Studio 2013\Projects\LuckyTurtles.ASP.NET.MVC.VideoTutorials\Team Project\SEDC.LuckyTurtles.OLS\LuckyTurtles.ASP.NET.MVC.VideoTutorials\Models\VIdeoTutsDB.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_History_Users]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Histories] DROP CONSTRAINT [FK_History_Users];
GO
IF OBJECT_ID(N'[dbo].[FK_History_Videos]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Histories] DROP CONSTRAINT [FK_History_Videos];
GO
...
GO
IF OBJECT_ID(N'[dbo].[RejectMessages]', 'U') IS NOT NULL
    DROP TABLE [dbo].[RejectMessages];
GO
...
-- Creating table 'RejectMessages'
CREATE TABLE [dbo].[RejectMessages] (
    [Id] int IDENTITY(1,1) NOT NULL,
...
-- Creating primary key on [Id] in table 'RejectMessages'
ALTER TABLE [dbo].[RejectMessages]
ADD CONSTRAINT [PK_RejectMessages]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
-- Creating foreign key on [videoId] in table 'Histories'
ALTER TABLE [dbo].[Histories]
